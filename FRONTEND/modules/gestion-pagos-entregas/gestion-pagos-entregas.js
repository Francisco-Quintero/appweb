...
function actualizarTablaEntregas() {
    ...
    gestionPagosEntregasState.entregas.forEach(entrega => {
        ...
        tr.innerHTML = `
            ...
            <td>
                ${entrega.estado === 'Pendiente' 
                    ? `<button onclick="window.abrirModalRegistroPago(${entrega.id})">Registrar Pago</button>`
...
function actualizarResumen() {
    ...
    gestionPagosEntregasState.entregas.forEach(entrega => {
        totalRecaudado += entrega.efectivo + entrega.transferencia;
        totalEfectivo += entrega.efectivo;
        totalTransferencias += entrega.transferencia;
    });
...
function registrarPago(event) {
    ...
    console.log('Datos del pago:', { 
        ...
        montoEfectivo, 
        montoTransferencia,
        formDataEfectivo: formData.get('monto-efectivo'),
        formDataTransferencia: formData.get('monto-transferencia')
    });
...
inicializarModuloGestionPagosEntregas();