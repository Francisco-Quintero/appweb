    ...
    function cargarCompras() {
        ...
        cuerpoTabla.innerHTML = comprasData.map(compra => `
            <tr>
                ...
                <td><button onclick="verDetallesCompra(${compra.id})" class="btn btn-secundario">Ver más</button></td>
            </tr>
        `).join('');
    }
            ...
            <div class="producto-resultado">
                ...
                <div class="variantes-lista">
                    ${resultado.variantes.map(variante => `
                        <div class="variante-item" onclick="seleccionarProducto(${JSON.stringify(resultado.producto)}, ${JSON.stringify(variante)})">
