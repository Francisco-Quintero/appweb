...
(function() {
    ...
    function agregarOEditarProducto() {
        console.log('Agregando o editando prododucto').value;
        const nombreProveedor = document.getElementById('busquedaProveedor').value;ucto');
        const nombre = document.getElementById('busquedaPr
