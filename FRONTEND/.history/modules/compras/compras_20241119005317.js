if (!window.moduloCompras) {
    ...
    function seleccionarProducto(idProducto, idVariante) {
        console.log('Seleccionando producto:', idProducto, 'variante:', idVariante);
        ...
        busquedaInput.value = `${producto.Nombre} - ${variante.descripcion}`;
        busquedaInput.dataset.productoId = idProducto;
        busquedaInput.dataset.varianteId = idVariante;
    ...
    function mostrarResultadosBusqueda(resultados) {
        ...
        divResultados.innerHTML = resultados.map(resultado => `
            <div class="producto-resultado" data-producto-id="${resultado.producto.idProducto}">
                ...
                <div class="variantes-lista">
                    ${resultado.variantes.map(variante => `
                        <div class="variante-item" data-variante-id="${variante.id_variante}">
        ...
        divResultados.addEventListener('click', handleVarianteClick);
    }
    function handleVarianteClick(event) {
        ...
        const productoResultado = varianteItem.closest('.producto-resultado');
        const idProducto = parseInt(productoResultado.dataset.productoId);
        const idVariante = parseInt(varianteItem.dataset.varianteId);
