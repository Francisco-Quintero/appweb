(function() {
    ...
    function cargarCompras() {
        ...
        if (!cuerpoTabla) {
            console.error('No se encontró el elemento cuerpoTablaCompras. Verificar ID en HTML.');
            return;
        }
    ...
    function cargarProveedores() {
        ...
        if (!selectProveedor) {
            console.error('No se encontró el elemento select de proveedores. Verificar ID en HTML.');
            return;
        }
