(function() {
    ...
    function limpiarFormularioCompra() {
        ...
        document.getElementById('busquedaProveedor').value = '';
        suministros = [];
        indiceEditando = null;
    ...
    function mostrarResultadosBusqueda(resultados) {
        console.log('Mostrando resultados de búsqueda de productos');
    ...
    function guardarCompra() {
        ...
        const proveedorNombre = document.getElementById('busquedaProveedor').value;
        if (!proveedorNombre || suministros.length === 0) {
    ...
    function mostrarResultadosProveedores(resultados) {
        console.log('Mostrando resultados de búsqueda de proveedores');
