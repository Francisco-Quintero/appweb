...
(function() {
    ...
    function buscarProductos(termino) {
        ...
        return productos.filter(productos =>
            console.log("contenido producto " + producto.nombre),
            productos.nombre.toLowerCase().includes(termino.toLowerCase()) ||
            productos.descripcion.toLowerCase().includes(termino.toLowerCase())
        );
    }
