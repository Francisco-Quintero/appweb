...
(function() {
            ...
            productos: [
                {
                    ...
                    cantidad: 50,
                    unidad: 'litro',
                    precioCompraTotal: 1100.00,
                    precioUnitarioFinal: 26400
                },
                {
                    id_variante: 2,
                    id_producto: 1,
                    ...
                    cantidad: 20,
                    unidad: 'litro',
                    precioCompraTotal: 400.00,
                    precioUnitarioFinal: 24000
                }
            ]
        },
        {
            ...
            productos: [
                ...
                },
                {
                    ...
                    cantidad: 10,
                    unidad: 'kg',
                    precioCompraTotal: 540.00,
                    precioUnitarioFinal: 64800
                }
            ]
        },
        {
            ...
            subtotal: 1512.60,
            impuesto: 287.40,
            observaciones: 'Entrega en sucursal principal',
            productos: [
                {
                    id_variante: 1,
                    id_producto: 1,
    ...
    // Actualizar los datos de proveedores para reflejar la frecuencia de abastecimiento
    const proveedores = [
        { id: 1, nombre: 'Alqueria', numeroContacto: 3502874505, frecuenciaAbastecimiento: 2 },
        { id: 2, nombre: 'Colanta' , numeroContacto: 3205689480, frecuenciaAbastecimiento: 1 },
    ];
    
    // Añadir más variantes de productos
