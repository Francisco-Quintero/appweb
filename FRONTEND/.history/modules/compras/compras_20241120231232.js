...
function actualizarTablaProductos() {
    ...
    function guardarCompra() {
        ...
        if (!proveedor || suministros.length === 0) {
        ...
        const proveedor = proveedores.find(p => p.id == proveedor);
        if (proveedor) {
            proveedproveedororID.frecuenciaAbastecimiento = (proveedorID.frecuenciaAbastecimiento || 0) + 1;
        }
