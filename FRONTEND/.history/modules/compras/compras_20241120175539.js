...
(function() {
    ...
    function buscarProductos(termino) {
        ...
        return productos.filter(producto =>
            ...
            producto.unidadMedida.toLowerCase().includes(termino.toLowerCase()) ||
            producto.valorMedida.toLowerCase().includes(termino.toLowerCase())
        );
    }
    ...
    function mostrarResultadosBusqueda(resultados) {
        ...
        resultados.forEach(producto => {
            ...
            div.textContent = `${producto.nombre} - ${producto.descripcion} - ${producto.unidad} - ${producto.valorMedida}`;
    ...
    function buscarCompras() {
        ...
        const comprasFiltradas = COMP.filter(c => 
