if (!window.moduloCompras) {  // Only declare if it doesn't exist
    ...
    function mostrarResultadosBusqueda(resultados) {
                        ...
                        ${resultado.variantes.map(variante => {
                            ...
                            return `
                                <div class="variante-item" 
                                     ...
                                     onclick="window.moduloCompras.seleccionarProducto(this.dataset.producto, this.dataset.variante)">
        ...
        // Agregar estilos para mejorar la interacción
...
if (window.moduloCompras) {
    window.moduloCompras.seleccionarProducto = seleccionarProducto;
}