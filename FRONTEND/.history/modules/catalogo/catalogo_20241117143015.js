(function() {
    ...
    function renderizarCatalogo() {
        ...
        // Limpiar los event listeners existentes antes de renderizar
        cleanup();
    ...
    function configurarEventListeners() {
        ...
        // Un solo event listener para todos los botones usando event delegation
        ...
        // Un solo event listener para todos los inputs usando event delegation
    ...
    function actualizarCantidadDesdeProducto(productoId, operacion) {
        ...
        try {
            ...
            if (operacion === 'sumar') {
                if (itemIndex !== -1) {
                    appState.carrito[itemIndex].cantidad = appState.carrito[itemIndex].cantidad + 1;
                } else {
