    ...
    function guardarInventario(){
        ...
        const nuevo = {
            ...
            estado: calcularEstado(
                parseInt(document.getElementById('stockActual').textContent.slice(1)),
                parseInt(document.getElementById('puntoReorden').textContent.slice(1))
            )
        }

        function calcularEstado(stock, puntoReorden) {
            const porcentaje = (stock / puntoReorden) * 100;
