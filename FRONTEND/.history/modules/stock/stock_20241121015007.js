    ...
    function guardarInventario(){
        ...
        const inventario = {
            ...
            idProducto: productos.id,
             ...
             stock: document.getElementById('stockActual').value,
             puntoReorden: parseFloat(document.getElementById('observaciones').textContent.slice(1)),
             document.getElementById('puntoReorden').value,
             observaciones: parseFloat(document.getElementById('observaciones').textContent.slice(1)),
