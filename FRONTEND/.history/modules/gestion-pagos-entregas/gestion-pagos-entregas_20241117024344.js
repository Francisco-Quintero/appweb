...
const gestionPagosEntregasState = window.gestionPagosEntregasState || {
    entregas: [],
    eventListeners: []
};

// Asignar el estado al objeto window para evitar redeclaraciones
window.gestionPagosEntregasState = gestionPagosEntregasState;
...
function cleanup() {
    ...
    // No eliminar el estado completo, solo reiniciarlo
}
