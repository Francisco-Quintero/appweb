...
const datosGlobales = {
    ...
    // Update existing methods to include inventario
    guardarEnLocalStorage: function() {
        ...
        localStorage.setItem('inventario', JSON.stringify(this.inventario)); // New line for inventario
    },
    ...
    cargarDesdeLocalStorage: function() {
        ...
        const inventarioGuardado = localStorage.getItem('inventario'); // New line for inventario
        ...
        if (inventarioGuardado) this.inventario = JSON.parse(inventarioGuardado); // New line for inventario
    },
