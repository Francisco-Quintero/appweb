            ...
            .then(html => {
                ...
                script.onload = function() {
                    if (nombreModulo === 'compras') {
                        ...
                        if (typeof window.moduloCompras !== 'undefined' && typeof window.moduloCompras.inicializar === 'function') {
                            window.moduloCompras.inicializar();
                        } else {
                            console.error('El módulo de compras no se ha cargado correctamente');
                        }
                    } else {
