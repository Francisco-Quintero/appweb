...
function loadModule(moduleName) {
    ...
    fetch(`/FRONTEND/modules/${moduleName}/${moduleName}.html`)
        ...
        .then(html => {
            ...
            link.rel = 'stylesheet';
            link.href = `/FRONTEND/modules/${moduleName}/${moduleName}.css`;
            link.setAttribute('data-module', moduleName);
            document.head.appendChild(link);
            
            // Cargar el script del módulo
            const script = document.createElement('script');
            script.src = `/FRONTEND/modules/${moduleName}/${moduleName}.js`;
